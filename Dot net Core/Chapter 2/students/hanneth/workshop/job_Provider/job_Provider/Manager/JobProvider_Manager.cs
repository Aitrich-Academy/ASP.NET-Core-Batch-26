...
namespace job_Provider.Manager
{
        public class Job_Provider_Manager : IUserRepository, IjobRepository
        {

            job_Provider.Model.JobProvider provid = new job_Provider.Model.JobProvider();
            Job job = new Job();
            private const int Max_JProvider = 10;
            private const int Max_jobs = 100;
            Model.JobProvider[] Provider = new Model.JobProvider[Max_JProvider];
